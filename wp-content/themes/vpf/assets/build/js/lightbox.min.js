...
function loadHtml5LightBox(jsFolder) {
    (function ($) {
        $.fn.html5lightbox = function (options) {
            ...
            inst.options = jQuery.extend({
                ...
                fadespeed: 400,
                jsfolder: jsFolder,
                skinsfoldername: "/wp-content/themes/indian-springs/assets/images/",
            ...
            inst.showNavigation = function () {
                ...
                var index = 0;
                for (i = 0; i < inst.elemArray.length; i++) if (group == inst.elemArray[i][ELEM_GROUP]) if (inst.elemArray[i][ELEM_THUMBNAIL] && inst.elemArray[i][ELEM_THUMBNAIL].length > 0) {
                    $(".html5-nav-list").append("<div class='html5-nav-thumb' data-arrayindex='" + i + "' style='float:left;overflow:hidden;cursor:pointer;opacity:" + inst.options.thumbopacity + ";margin: 0 " + inst.options.thumbgap / 2 + "px;width:" + inst.options.thumbwidth + "px;height:" + inst.options.thumbheight + "px;border:" + inst.options.thumbborder + "px solid " + inst.options.thumbbordercolor + ";'><img style='width:100%;' src='" + inst.elemArray[i][ELEM_THUMBNAIL] + "' /></div>");
                    index++
                }
            ...
            inst.resizeLightbox = function (elemW, elemH, bAnimate, onFinish) {
                ...
                if (inst.options.titlestyle !=
                    "inside") boxT -= Math.round(inst.options.barheight / 2);
    ...
    jQuery(document).ready(function () {
        if (typeof html5Lightbox === "undefined") html5Lightbox = jQuery(".lightbox").html5lightbox()
    })
};